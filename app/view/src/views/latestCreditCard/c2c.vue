    ...
    <section class="c2c">
        ...
        <div class="fuz-page-content fuz-card-padding">
          ...
          <div class='fuz-content-small'>
            1. Open trades listed on the platform are verified by FUZIONX.
          ...
          <div class='fuz-content-small fuz-gap'>
            ...
            “USDT” and “ZENITH” in the remarks field to avoid delays or transaction failures.
          </div>
          <div class='fuz-content-small fuz-gap'>
          ...
          <div class='fuz-content-small'>
            4. FUZIONX reserves the right to disable user accounts,
