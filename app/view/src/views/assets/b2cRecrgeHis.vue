...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/assets/b2cRecrgeHis/b2cRecrgeHis';
import 'BlockChain-ui/PC/common-mixin/assets/b2cRecrgeHis/b2cRecrgeHis.styl';
