<template>
  <section class="v5-page-exchangeOrder fuz-card">
...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/newOrder/exchangeOrder/exchangeOrder';
import 'BlockChain-ui/PC/common-mixin/newOrder/exchangeOrder/exchangeOrder.styl';
...
<style scoped>
.v5-page-exchangeOrder >>> .table-body td {
  white-space: nowrap;
}
</style>
