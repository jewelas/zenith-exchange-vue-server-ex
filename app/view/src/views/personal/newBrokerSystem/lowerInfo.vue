...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/personal/newBrokerSystem/lowerInfo/lowerInfo';
import 'BlockChain-ui/PC/common-mixin/personal/newBrokerSystem/lowerInfo/lowerInfo.styl';
