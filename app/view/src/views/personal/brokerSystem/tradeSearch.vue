...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/personal/brokerSystem/tradeSearch/tradeSearch';
import 'BlockChain-ui/PC/common-mixin/personal/brokerSystem/tradeSearch/tradeSearch.styl';
