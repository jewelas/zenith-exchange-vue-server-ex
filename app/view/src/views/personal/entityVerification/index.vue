<template>
  <div class="entityVerification verificationCenter fuz-card">
    ...
    <ul class="kyc-level_list">
      ...
      <li
        ...
        <div class="level-content a-3-bd">
          ...
          <h6 class="cryptoLimits b-1-cl">{{$t('enterpriseCert.rights')}}</h6>
          <dl class="limit-item">
          ...
          <dl v-if="item.equityFieldStrList.length" class="limit-item">
            <dt class="b-1-cl">{{$t('verificationCenter.otherRight')}}</dt>
            <dd
              class="b-2-cl"
              v-for="right in item.equityFieldStrList"
              :key="right">
              {{right}}
            </dd>
          </dl>
    ...
    <c-dialog
      ...
      <div class="warnTip">
        {{$t('verificationCenter.warnTip', {
          type1: $t('enterpriseCert.title'),
          type2: $t('verificationCenter.personal')
        })}}
      </div>
    </c-dialog>
  </div>
...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/personal/entityVerification/index';
import 'BlockChain-ui/PC/common-mixin/personal/entityVerification/index.styl';
