  ...
  routes: [
    {
      ...
      name: 'coming',
      component: () => import('@/views/fuzionx/comingSoon.vue'),
    },
    {
      path: `${routerEnv}/affiliate`,
      name: 'affiliate',
      component: () => import('@/views/fuzionx/affiliate.vue'),
    },
    {
      path: `${routerEnv}/about`,
      name: 'aboutUs',
      component: () => import('@/views/fuzionx/aboutUs.vue'),
    },
    {
      path: `${routerEnv}/riskDisclosure`,
      name: 'statement',
      component: () => import('@/views/fuzionx/riskDisclosure.vue'),
    },
    {
      path: `${routerEnv}/userAgreement`,
      component: () => import('@/views/fuzionx/userAgreement.vue'),
    },
    ...commonRouter,
    // 个人中心
    ...personalRouter,
