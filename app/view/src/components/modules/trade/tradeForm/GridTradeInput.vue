...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/modules/trade/tradeForm/tradeInput/tradeInput';
import 'BlockChain-ui/PC/common-mixin/modules/trade/tradeForm/tradeInput/tradeInput.styl';
