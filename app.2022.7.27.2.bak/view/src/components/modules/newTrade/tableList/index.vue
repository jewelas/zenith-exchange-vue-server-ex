            ...
            <template v-for="(item, index) in dataList">
              <div
                ...
                <span class="td-symbol"
                      ...
                      :class="priceClass"
                      :style="{'width': cellWidth[0] + 'px'}">
                  <b class="hover_hide">{{item.price | formatNum}}</b>
                  <b class="hover_show">{{item.rate | formatNum}}</b>
                </span>
                <!-- 数量 -->
                <span class="td-price"
                      :style="{'width': cellWidth[1] + 'px'}">
...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/modules/newTrade/tableList/tableList';
import 'BlockChain-ui/PC/common-mixin/modules/newTrade/tableList/tableList.styl';
