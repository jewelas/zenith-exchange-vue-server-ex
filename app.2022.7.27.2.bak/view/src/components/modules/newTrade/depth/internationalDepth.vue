...
import 'BlockChain-ui/PC/common-mixin/modules/newTrade/depath/internationalDepth/internationalDepth.styl';
import tableList from '@/components/modules/newTrade/tableList/index.vue';
// 实时成交
import newTrade from '@/components/modules/newTrade/currentTrade/index.vue';
