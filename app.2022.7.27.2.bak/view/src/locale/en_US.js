module.exports = {
  ...
  invitePrize: {
    ...
    immediately_enjoy: 'Enjoy',
    reward: 'Rewards',
    banner_txt: 'Rewarding · Transparent · Instant Redemption',
    banner_form_title: 'Invitation Method',
    banner_form_link: 'Invitation Reward Description',
    invite_code: 'Invitation code',
    invite_link: 'Invitation link',
    step_title: 'How to get rebate income?',
    step_one: 'Send invitation',
    step_two: 'Friends complete registration and trade',
    step_three: 'Get rebate income',
    statistical_title: 'Dashboard',
    statistical_number: 'Friends',
    statistical_rewardAmount: 'Rewards(USDT)',
    statistical_AmountTop: 'Top Referrer Bonus(USDT)',
    statistical_ranking: 'Leaderboard',
    conditions_award: 'Reward distribution conditions:',
    conditions_one: 'Friends who complete the following tasks within {day} days after registration, you can get the corresponding inviter rewards:',
    conditions_two: 'Complete identity verification',
    conditions_three: 'Recharge amount≥',
    conditions_four: 'Cumulative transaction amount under {tradeSymbol} currency pair≥',
    conditions_inviter: 'Inviter Reward Amount:',
    conditions_inviterFather: 'Inviter parent bonus Amount:',
    conditions_registration: 'Registrant Reward Amount:',
    conditions_method: 'Reward distribution method:',
    conditions_methodBefore: 'After meeting the reward conditions,',
    conditions_sysItem: 'Automatically issued by the system',
    conditions_item: 'T+2 issue',
    invite_details: 'Invitation Details',
    invite_myInvite: 'My Invitation',
    invite_inviteRewards: 'My Invitation Reward',
    myInvite_friendsId: "Friend's User ID",
    myInvite_register: 'Registered Account',
    myInvite_registerTime: 'Registration Date',
    inviteRewards_time: 'Release Time',
    inviteRewards_register: 'Registered Account',
    inviteRewards_number: 'Rewards',
    inviteRewards_valuation: 'Valuation',
    copySuccess: 'Copied',
    copyError: 'This browser does not support automatic copying',
    modalInvite_textInfo: 'Invite you to join [{company}], long press to identify the QR code',
    download: 'Download',
    modalQRCode_title: 'Register Now. Earn Crypto Together.',
    modalRanking_title: 'List of reward rankings',
    modalRanking_txt: 'Reward rankings are updated hourly',
  },
};
