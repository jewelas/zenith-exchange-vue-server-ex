      ...
      <section class="toLoan-dialog-box">
        ...
        <ul class="toLoan-dialog-list">
          ...
          <li class="v5-9-bg">
            ...
            <span class="value v5-5-cl">{{ mortgageRate }}%</span>
          </li>
        </ul>
      </section>
    </c-v5-dialog>
      ...
      <section class="toLoan-dialog-box">
        <ul class="toLoan-dialog-list">
          ...
          <li class="v5-9-bg">
            ...
            <span class="value v5-5-cl">{{ detObj.id }}</span>
          </li>
          <!-- 实际计息天数 -->
          <li class="v5-9-bg">
            <span class="key">{{ $t('broToloan.toLoanHis.t22') }}</span>
            <span class="value v5-5-cl">{{ detObj.inserestDays }}
              <!-- 天 -->
              {{ $t('broToloan.toLoanHis.t14') }}
            </span>
          </li>
          ...
          <li class="v5-9-bg">
            ...
            <span class="value v5-5-cl">{{ getCoinName(detObj.mortgageSymbol) }}</span>
          </li>
          <!-- 抵押数量 -->
          <li class="v5-9-bg">
          ...
          <li class="v5-9-bg">
            ...
            <span class="value v5-5-cl">{{ detObj.mortgageRate }}%</span>
          </li>
          <!-- 预计平仓价格 -->
          <li class="v5-9-bg">
      ...
      <section class="toLoan-dialog-box">
        ...
        <ul class="toLoan-dialog-list" style="margin-top: 20px">
          ...
          <li class="v5-9-bg">
            ...
            <span class="value v5-5-cl">{{ setRateObj.mortgageRate }}%</span>
          </li>
          <!-- 本次补仓后质押率 -->
          <li class="v5-9-bg">
