...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/personal/brokerSystem/commission/commission';
import 'BlockChain-ui/PC/common-mixin/personal/brokerSystem/commission/commission.styl';
