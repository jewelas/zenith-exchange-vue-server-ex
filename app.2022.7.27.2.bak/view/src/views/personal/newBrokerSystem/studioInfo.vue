...
<script>
import mixin from 'BlockChain-ui/PC/common-mixin/personal/newBrokerSystem/studioInfo/studioInfo';
import 'BlockChain-ui/PC/common-mixin/personal/newBrokerSystem/studioInfo/studioInfo.styl';
