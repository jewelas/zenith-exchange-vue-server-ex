<template>
  <section class="page-otcTrade ">
    <div class="otc-page-title a-5-bg ">
    ...
    <div class="page-otcTrade-content  fuz-card">
      <vue-scroll>
        <div class="page-otcTrade-bar">
          ...
          <div class="otcTrade-header fuz-border">
            ...
            <div class="otcTrade-user">
              <div class="otcTrade-userName fuz-border">
          ...
          <!-- 主体 -->
          <div class="otcTrade-message fuz-border">
            ...
            <div class="otcTrade-message-box clearfix">
              ...
              <ul class="otcTrade-message-values b-1-cl">
                ...
                <li>{{axiosObj.volumeBalance | coinFixD(that)}}
                   {{ getShowCoin(axiosObj.coin) }}</li>
                <li>
